        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/35 px-4 py-8">
          <div className="panel w-full max-w-4xl rounded-[32px] p-6 shadow-2xl shadow-slate-900/20">
            <div className="mb-5 flex items-start justify-between gap-4">
              <div>
                <p className="mb-2 text-xs font-semibold uppercase tracking-[0.24em] text-brand">{editingTimesheet ? "Edit Timesheet" : "New Timesheet"}</p>
                <h2 className="display-font text-2xl font-semibold text-brand-strong">{editingTimesheet ? editingTimesheet.employeeName : "Enter employee timesheet hours"}</h2>
              </div>
